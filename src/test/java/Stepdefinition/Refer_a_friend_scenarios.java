...
public class Refer_a_friend_scenarios extends Generic_function{
	...
	public void login_with_valid_data() throws Exception {
		...
		login(6,7);
			...
			e.printStackTrace();
			takeScreenShot("refer_a_friend_login_with_valid_data");
		}
	}	
	...
	public static void verify_logo() throws Exception   {
		try {
			...
			e.printStackTrace();
			takeScreenShot("refer_a_friend_verify_logo");
		}
	}
	...
	public static void click_refer_friend() throws Exception   {
		try {
			...
			e.printStackTrace();
			takeScreenShot("refer_a_friend_click_refer_friend");
		}
	}
	...
	public void navigate_to_refer_a_friend_page() throws Exception {
		try {
			...
			e.printStackTrace();
			takeScreenShot("refer_a_friend_navigate_to_refer_a_friend_page");
		}
	}
	...
	public static void verify_referal_code() throws Exception   {
		try {
			...
			e.printStackTrace();
			takeScreenShot("refer_a_friend_verify_referal_code");
		}
	}
	...
	public static void clicks_on_share_link() throws Exception{
		try {
			...
			e.printStackTrace();
			takeScreenShot("refer_a_friend_clicks_on_share_link");
		}
	}
	...
	public static void clicks_on_copy_the_link() throws Exception   {
		try {
			...
			e.printStackTrace();
			takeScreenShot("refer_a_friend_clicks_on_copy_the_link");
		}
	}
	...
	public static void verify_text() throws Exception   {
		try {
			...
			e.printStackTrace();
			takeScreenShot("refer_a_friend_verify_text");
		}
	}
	...
	public static void first_grid_text_checker() throws Exception   {
		try {
			...
			e.printStackTrace();
			takeScreenShot("refer_a_friend_first_grid_text_checker");
		}
	}
	...
	public static void grid_slideer() throws Exception   {
		try {
			...
			e.printStackTrace();
			takeScreenShot("refer_a_friend_grid_slideer");
		}
	}
	...
	public static void nextslide() throws Exception   {
		try {
			...
			e.printStackTrace();
			takeScreenShot("refer_a_friend_nextslide");
		}
	}
	...
	public static void clicks_on_more_info() throws Exception   {
		try {
			...
			e.printStackTrace();
			takeScreenShot("refer_a_friend_clicks_on_more_info");
		}
	}
	...
	public static void verify_faq() throws Exception   {
		try {
			...
			e.printStackTrace();
			takeScreenShot("refer_a_friend_verify_faq");
		}
	}
}