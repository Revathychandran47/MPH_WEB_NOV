...
public class Bills_scenarios extends Generic_function{
	...
	public void browser_launching() throws Exception {
		try {
			...
			e.printStackTrace();
			takeScreenShot("bills_browser_launching");
		}
	}
	@When("Click on 'Bills'")
	public void click_on_bills() throws Exception {
		try {
			...
			e.printStackTrace();
			takeScreenShot("bills_click_on_bills");
		}
	}   
	...
	public void navigate_bills_page() throws Exception {
		try {
			...
			e.printStackTrace();
			takeScreenShot("bills_navigate_bills_page");
		}
	}
	...
	public void total_bills_due_visiblitiy() throws Exception {
		try {
			...
			e.printStackTrace();
			takeScreenShot("bills_total_bills_due_visiblitiy");
		}	
	}
	@Then("'Amount' visible on the page")
	public void amount_visible() throws Exception {
		try {
			...
			e.printStackTrace();
			takeScreenShot("bills_amount_visible");
		}	
	}
	...
	public void click_on_dropdown() throws Exception {
		try {
			...
			e.printStackTrace();
			takeScreenShot("bills_click_on_dropdown");
		}	
	}
	@Then("Select 'Newest'")
	public void select_newest() throws Exception {
		try {
			...
			e.printStackTrace();
			takeScreenShot("bills_select_newest");
		}	
	}
	...
	public void click_on_due_section() throws Exception {
		try {
			...
			e.printStackTrace();
			takeScreenShot("bills_click_on_due_section");
		}	
	}	
	@Then("Click on 'Paid' section")
	public void click_paid_section() throws Exception {
		try {
			...
			e.printStackTrace();
			takeScreenShot("bills_click_paid_section");
		}	
	}
	...
	public void your_expense_grid() throws Exception {
		try {
			...
			e.printStackTrace();
			takeScreenShot("bills_your_expense_grid");
		}
	}
	...
	public void click_on_pay_a_bill() throws Exception {
		try {
			...
			e.printStackTrace();
			takeScreenShot("bills_click_on_pay_a_bill");
		}	
	}	
	...
	public void bills_due_section() throws Exception {
		try {
			...
			e.printStackTrace();
			takeScreenShot("bills_bills_due_section");
		}	
	}
	...
	public void click_on_explore_services() throws Exception {
		try {
			...
			e.printStackTrace();
			takeScreenShot("bills_click_on_explore_services");
		}	
	}	
	...
	public void navigation_service_page() throws Exception {
		try {
			...
			e.printStackTrace();
			takeScreenShot("bills_navigation_service_page");
		}	
	}
	...
	public void validation_msg() throws Exception {
		try {
			...
			e.printStackTrace();
			takeScreenShot("bills_validation_msg");
		}	
	}
}
