...
public class Services_scenarios extends Generic_function {
	...
	public void click_login_button() throws Exception {
		try {
			...
			e.printStackTrace();
			takeScreenShot("services_click_login_button");
		}
	}
	...
	public void navigate_to_login() throws Exception {
		try {
			...
			e.printStackTrace();
			takeScreenShot("services_navigate_to_login");
		}
	}
	...
	public static void click_on_services() throws Exception{
		...
		{
			e.printStackTrace();
			takeScreenShot("services_click_on_services");
		}
	}
	...
	public static void navigate_to_services() throws Exception{
		...
		{
			e.printStackTrace();
			takeScreenShot("services_navigate_to_services");
		}
	}
	...
	public void click_on_all_tiles() throws Exception {
		try {
			grid_tiles(OR_reader("grid_path"),"services");
			browser_wait(1000);
			value = driver.findElement(By.xpath(OR_reader( "logout"))).isDisplayed();
			Assert.assertEquals(true,value);
		...
		{
			e.printStackTrace();
			takeScreenShot("services_click_on_all_tiles");
		}		
	}
}