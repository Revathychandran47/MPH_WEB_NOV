...
public class Second_opinion_dashboard_scenarios extends Generic_function {
	...
	public void Requestedpage() throws Exception {
		try {
			...
			e.printStackTrace();
			takeScreenShot("second_opinion_dashboard_positive_requestedpage");
		}
	...
	public void Reviewedpage() throws Exception {
		try {
			...
			e.printStackTrace();
			takeScreenShot("second_opinion_dashboard_positive_Reviewedpage");
		}		
	}
}
