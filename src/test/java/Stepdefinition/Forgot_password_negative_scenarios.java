...
public class Forgot_password_negative_scenarios extends Generic_function {
	...
	public void phonenumber_blank() throws Exception {
		try{
			...
			e.printStackTrace();
			takeScreenShot("AwardPoints_negative_phonenumber_blank");
		}
	}
	...
	public void validate_error_msg() throws Exception  {
		try {
			...
			e.printStackTrace();
			takeScreenShot("AwardPoints_negative_validate_error_msg");
		}
	}
	...
	public void enter_less_digits() throws IOException {
		try{
			...
			e.printStackTrace();
			takeScreenShot("AwardPoints_negative_enter_less_digits");
		}
	}
	@Then("Validate the error message for less than ten digits")
	public void validate_error_msg2() throws Exception {
		try {
			browser_wait(1200);
			browser_refresh();
		} catch (Exception e) {
			e.printStackTrace();
			takeScreenShot("AwardPoints_negative_validate_error_msg2");
		}
	}
	...
	public void enter_more_digits() throws Exception {
		try{
			...
			e.printStackTrace();
			takeScreenShot("AwardPoints_negative_enter_more_digits");
		}
	}
