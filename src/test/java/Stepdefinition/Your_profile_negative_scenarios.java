...
public class Your_profile_negative_scenarios extends Generic_function {
	...
	public void click_on_contact_details() throws Exception {
		try{
			...
			e.printStackTrace();
			takeScreenShot("your_profile_negative_click_on_contact_details");
		}
	}
	...
	public void click_on_contact_details_button() throws Exception {
		try{
			...
			e.printStackTrace();
			takeScreenShot("your_profile_negative_click_on_contact_details_button");
		}
	}
	...
	public void click_on_phone_number() throws Exception{
		try{
			...
			e.printStackTrace();
			takeScreenShot("your_profile_negative_click_on_phone_number");
		}
	}
	...
	public void click_on_address() throws Exception{
		try{
			...
			e.printStackTrace();
			takeScreenShot("your_profile_negative_click_on_address");
		}
	}
	...
	public void click_new_address() throws Exception{
		try{
			...
			e.printStackTrace();
			takeScreenShot("your_profile_negative_click_new_address");
		}
	}
	...
	public static void invalid_zipcode() throws Exception{
		try{
			...
			e.printStackTrace();
			takeScreenShot("your_profile_negative_invalid_zipcode");
		}
	}
	...
	public static void blank_password() throws Exception{
		try{
			...
			e.printStackTrace();
			takeScreenShot("your_profile_negative_blank_password");
		}
	}
