...
public class Awardpoints_negative_scenarios extends Generic_function{
	...
	public void login() throws Exception {
		try {
			...
			e.printStackTrace();
			takeScreenShot("AwardPoints_negative_login");
		}
	}
	@And("Click on Utilities tab")
	public static void click_utilities() throws Exception{
		try {
			...
			e.printStackTrace();
			takeScreenShot("AwardPoints_negative_click_utilities");
		}
	}
	@Then("Click on Award Points")
	public void click_on_awardpoints() throws Exception {
		try {
			click("award_points");
			browser_wait(9000);
		} catch (Exception e) {
			e.printStackTrace();
			takeScreenShot("AwardPoints_negative_click_on_awardpoints");
		}
	}
	...
	public void click_redeem_points() throws Exception {
		try {
			...
			e.printStackTrace();
			takeScreenShot("AwardPoints_negative_click_redeem_points");
		}
	}
	...
	public void greater_amount() throws Exception, InterruptedException {
		try {
			...
			e.printStackTrace();
			takeScreenShot("AwardPoints_negative_greater_amount");
		}
	}
	...
	public void validate_msg() throws Exception {
		try{
			...
			e.printStackTrace();
			takeScreenShot("AwardPoint_negative_validate_msg");
		}
	}
	...
	public void lesser_Amount() throws Exception {
		try {
			...
			e.printStackTrace();
			takeScreenShot("AwardPoints_negative_lesser_amount");
		}
	}
	...
	public void validate_msg_on_less_amount() throws Exception {
		try {
			...
			e.printStackTrace();
			takeScreenShot("AwardPoints_negative_validate_msg_on_less_amount)");
		}
	}
	...
	public void redeemButton_giftcardblank() throws Exception {
		try{
			...
			e.printStackTrace();
			takeScreenShot("Awardpoints_negative_redeemButton_giftcardblank");
		}
	}
	...
	public static void validate_error_msg() throws Exception, InterruptedException {
		try {
			...
			e.printStackTrace();
			takeScreenShot("AwardPoint_negative_validate_error_msg");
		}
	}
	...
	public static void blank_amount_redeem_button() throws Exception{
		try {
			...
			e.printStackTrace();
			takeScreenShot("AwardPoints_negative_blank_amount_redeem_button");
		}
	}
	...
	public void validate_msg_displayed() throws Exception {
		try{
			...
			e.printStackTrace();
			takeScreenShot("AwardPoints_negative_validate_msg_displayed");
		}		
	}
}
